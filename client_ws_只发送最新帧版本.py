...
class WebcamClient:
    def __init__(self, server_url='62.234.21.131:8765'):
    ...
    def codificar_imagem(self, frame):
        ...
        encode_param = [int(cv2.IMWRITE_JPEG_QUALITY), 100]  # Qualidade JPEG reduzida para maior velocidade
...
def main():
#client = WebcamClient(server_url="211.159.147.252:8765")
    client = WebcamClient()
    client.executar()
